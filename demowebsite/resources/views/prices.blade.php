...
<body>
    <div id="wrapperadmin">
        ...
        <div class="contactcontainer">
            <div class="row">
                <form method="post" action="/pricescreate" enctype="multipart/form-data" style="border:whitesmoke solid;box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2);width:120%">
                <input type = "hidden" name = "_token" value = "<?php echo csrf_token(); ?>"> 
                    ...
                    <input type="number" name="serviceid" min="31"  style="width:95px;height:40px;margin-right:20px;margin-left:58px;border-radius:20px">
          
                    <br><br><label for="price">Price:</label>
                    <input type="number" name="price" min="1" max="50000" style="width:95px;height:40px;margin-right:20px;margin-left:95px;border-radius:20px">

                    <br><br><label for="jname">Job Name:</label>
                    <input type="text" name="jname" style="width:100px;margin-right:20px;margin-left:49px">

                    <br><br><label for="service1">Service1:</label>
                    <input type="text" name="service1" style="width:100px;margin-right:20px;margin-left:67px">

                    <br><br><label for="service2">Service2:</label>
                    <input type="text" name="service2" style="width:100px;margin-right:20px;margin-left:64px">

                    <br><br><label for="service3">Service3:</label>
                    <input type="text" name="service3" style="width:100px;margin-right:20px;margin-left:64px">

                    <br><br><label for="service4">Service4:</label>
                    <input type="text" name="service4" style="width:100px;margin-right:20px;margin-left:64px">

                    <br><br><label for="link">Link:</label>
                    <input type="text" name="link" style="width:100px;margin-right:20px;margin-left:93px">
                ...
                <table border='1' style="margin-right:20%;margin-left:-30%">
                                    ...
                                    <tr>
                                          ...
                                          <td><button name="delete" type="submit" style="width:80px; height:40px; padding-bottom:5px; margin-right:5px"><a href = '/pricesdestroy/{{$prices->ServiceId}}' style="text-decoration:none">Delete</a></button></td>
                                          <td><button name="update" type="submit" style="width:80px; height:40px; padding-bottom:5px; margin-right:5px; margin-left:10%"><a href = '/pricesupdate/{{$prices->ServiceId}}' style="text-decoration:none">Update</a></button></td>
                                    </tr>
                                    @endforeach
                              </table>
            </div>
