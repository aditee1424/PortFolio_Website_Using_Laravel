...
<body>
    <div id="wrapperadmin">
        ...
        <div class="contactcontainer">
            <div class="row">
                <form method="post" action="/workcreate" style="border:whitesmoke solid;box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2);">
                <input type = "hidden" name = "_token" value = "<?php echo csrf_token(); ?>">  
                    ...
                    <input type="number" name="workid" min="11"  style="width:95px;height:40px;margin-right:20px;margin-left:58px;border-radius:20px">
                   
                   
                    <br><br><label for="startm">Start Month:</label>
                    <input type="text" name="startm" pattern="(jan|JAN|feb|FEB|march|MARCH|april|APRIL|may|MAY|jun|JUNE|july|JULY|aug|AUG|sept|SEPT|oct|OCT|nov|NOV|dec|DEC)" style="width:100px;margin-right:20px;margin-left:27px">

                    <br><br><label for="starty">Start Year:</label>
                    <input type="text" name="starty" pattern="(?:19|20)\d{2}" style="width:100px;margin-right:20px;margin-left:46px">

                    <br><br><label for="endm">End Month:</label>
                    <input type="text" name="endm" pattern="(jan|JAN|feb|FEB|march|MARCH|april|APRIL|may|MAY|jun|JUNE|july|JULY|aug|AUG|sept|SEPT|oct|OCT|nov|NOV|dec|DEC)" style="width:100px;margin-right:20px;margin-left:35px">

                    <br><br><label for="endy">End Year:</label>
                    <input type="text" name="endy" pattern="(?:19|20)\d{2}" style="width:100px;margin-right:20px;margin-left:54px">

                    <br><br><label for="company">Company:</label>
                    <input type="text" name="company" style="width:100px;margin-right:20px;margin-left:50px">

                    <br><br><label for="pos">Position:</label>
                    <input type="text" name="pos" style="width:100px;margin-right:20px;margin-left:63px">

                    <br><br><label for="desc">Description:</label>
                    <input type="text" name="desc" style="width:100px;margin-right:20px;margin-left:41px">
                ...
                <table border='1' style="margin-right:20%;margin-left:-20%">
                                    ...
                                    <tr>
                                          ...
                                          <td><button name="delete" type="submit" style="width:80px; height:40px; padding-bottom:5px; margin-right:5px"><a href = '/workdestroy/{{$workexp->WorkId}}' style="text-decoration:none">Delete</a></button></td>
                                          <td><button name="update" type="submit" style="width:80px; height:40px; padding-bottom:5px; margin-right:5px; margin-left:10%"><a href = '/workupdate/{{$workexp->WorkId}}' style="text-decoration:none">Update</a></button></td>
                                    </tr>
                                    @endforeach
                              </table>
            </div>
