...
<body>
    <div id="wrapperadmin">
        ...
        <div class="contactcontainer">
            <div class="row">
                <form method="post" action="/portfolioedit/<?php echo $portfolio[0]->ProjectId; ?>" enctype="multipart/form-data" style="border:whitesmoke solid;box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2); width:120%">
                ...
                <button name="update" type="submit" style="width:80px; height:40px; padding-bottom:5px; margin-right:5px; margin-left:10%">Update</button>
                    ...
                    <input type="number" value = '<?php echo $portfolio[0]->ProjectId; ?>' name="projectid" min="1" style="width:95px;height:40px;margin-right:20px;margin-left:65px;border-radius:20px">
                    

                    <br><br><label for="projecttitle">Project Title:</label>
                    <input type="text" value = '<?php echo $portfolio[0]->ProjectTitle; ?>' name="projecttitle" style="width:100px;margin-right:20px;margin-left:48px">

                    <br><br><label for="projecttype">Project Type:</label>
                    <input type="text" value = '<?php echo $portfolio[0]->ProjectType; ?>' name="projecttype" style="width:100px;margin-right:20px;margin-left:41px">
            ...
            <table border='1'>
                                    ...
                                    <tr>
                                          ...
                                          <td style="width:100%">  <?php echo '<img src="data:image/png;base64,' . $portfolio->Image . '" style="width:50%;height:50%;margin-left:20%"/>' ?></td>
                                    </tr>
                                    @endforeach
                              </table>
        </div>
