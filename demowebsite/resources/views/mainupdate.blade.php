...
<body>
      <div id="wrapperadmin">
            ...
            <div class="contactcontainer">
                  <div class="row">
                        <form method="post" action="/mainedit/<?php echo $portfolioimage[0]->UserId; ?>" enctype="multipart/form-data" style="border:whitesmoke solid;box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2);">
                        ...
                        <button name="update" type="submit" style="width:80px; height:40px; padding-bottom:5px; margin-right:5px; margin-left:10%">Update</button>
                              ...
                              <input type="text" name="title" value = '<?php echo $portfolioimage[0]->Title; ?>' style="width:100px;margin-right:20px;margin-left:15px">

                              <br><br><label for="jobs">Jobs:</label>
                              <input type="text" name="jobs" value = '<?php echo $portfolioimage[0]->Jobs; ?>' style="width:100px;margin-right:20px;margin-left:11px">
                    ...
                    <input type="file" name="myimage" style="width:100px;margin-right:20px;margin-left:90px">
                        ...
                        <table border='1'>
                                    ...
                                    <tr>
                                          ...
                                          <td style="width:100%">  <?php echo '<img src="data:image/png;base64,' . $portfolioimage->Image . '" style="width:300%;height:50%;margin-left:20%"/>' ?></td>
