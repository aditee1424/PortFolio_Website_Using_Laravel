...
<body>
      <div id="wrapperadmin">
            ...
            <div class="contactcontainer">
                  <div class="row">
                        <form method="post" action="/skillsedit/<?php echo $skills[0]->SkillId; ?>" style="border:whitesmoke solid;box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2);">
                        ...
                        <button name="update" type="submit" style="width:80px; height:40px; padding-bottom:5px; margin-right:5px; margin-left:10%">Update</button>
                              ...
                              <input type="number" name="skillid" value = '<?php echo $skills[0]->SkillId; ?>' min="1"  style="width:100px;height:30px;margin-right:20px;margin-left:95px;border-radius:20px">
                              <br> <label for="lang">Language:</label>
                              <input type="text" name="lang" value = '<?php echo $skills[0]->Language; ?>' max="100" style="width:100px;;height:30px;margin-right:20px;margin-left:65px;">
                              <br><label for="per">Percentage:</label>
                              <input type="number" name="per" value = '<?php echo $skills[0]->Percentage; ?>'style="width:100px;height:30px;margin-right:20px;margin-left:55px;border-radius:20px">
